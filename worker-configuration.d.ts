/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f7168429047b265ec9f5c068bf7501a8)
// Runtime types generated with workerd@1.20260426.1 2026-04-29 global_fetch_strictly_public
declare namespace Cloudflare {
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
		CLIENT_NAME: "Rubrion EdgePress";
		CLIENT_DOMAIN: "web-rubrion-edgepress.rubrion.workers.dev";
		CLIENT_TAGLINE: "Notes, essays, and announcements — straight to your inbox.";
		CLIENT_LOGO_URL: "";
		CLIENT_FAVICON_URL: "";
		CLIENT_FONT: "";
